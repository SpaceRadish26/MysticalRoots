...
public class MysticalRoots {
    ...
    private void clientSetupEvent(final FMLClientSetupEvent event) {
        ...
        ItemBlockRenderTypes.setRenderLayer(ModBlocks.POTTED_ZINNIA_FLOWER_YELLOW.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(ModBlocks.ZINNIA_FLOWER_LPURPLE.get(), RenderType.cutout());
        ItemBlockRenderTypes.setRenderLayer(ModBlocks.POTTED_ZINNIA_FLOWER_LPURPLE.get(), RenderType.cutout());
