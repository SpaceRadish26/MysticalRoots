...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    LEMON("lemon", 15, new int[]{2, 5, 6, 2}, 9, SoundEvents.ARMOR_EQUIP_IRON, 0.0F, 0.0F, () -> {
        return Ingredient.of(ModItems.LEMON.get());
    }),
    JAPANESE("japanese", 15, new int[]{2, 5, 6, 2}, 9, SoundEvents.ARMOR_EQUIP_IRON, 0.0F, 0.0F, () -> {
        return Ingredient.of(ModItems.LEMON.get());
    }),
